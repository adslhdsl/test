...
import test.domain.MovieRegistered;
import test.domain.MovieModified;
import test.domain.MovieReserved;
import test.domain.MovieCancelled;
import test.domain.MovieDeleted;
import test.MovieApplication;
